...
export default function AuthLayout({
  ...
  // Dynamically generate title from path (same logic as AppLayout)
  useEffect(() => {
    ...
    // Build a readable title from segments
    let title = "";
    if (segments.length === 0) {
      title = "Dashboard";
    } else {
      // If first segment is 'auth', skip it for nicer titles (e.g. '/auth/signin' -> 'Signin')
