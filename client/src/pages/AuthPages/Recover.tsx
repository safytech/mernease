...
export default function Recover() {
  ...
  const onSubmit: SubmitHandler<IFormInput> = async (formData) => {
    try {
      ...
      if (res.ok) {
        coloredToast("success", "Password reset email sent successfully!");
  ...
  return (
    <>
      <PageMeta
        title="Recover Password | TailAdmin - React.js Dashboard Template"
        description="Recover your password in TailAdmin React.js Dashboard Template"
      />
      <AuthLayout>
